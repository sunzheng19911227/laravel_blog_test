        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                  <li><a href="index.html#"><i class="fa fa-user"></i> <span>Profile</span></a></li>
                  <li><a href="index.html#"><i class="fa fa-cog"></i> <span>Settings</span></a></li>
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-laptop"></i> <span>Layouts</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-book"></i> <span>UI Elements</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-cogs"></i> <span>Components</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-envelope"></i> <span>Mail</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-tasks"></i> <span>Forms</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html"><i class="fa fa-bar-chart-o"></i> <span>Charts</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="index.html#"><i class="fa fa-map-marker"></i> <span>Maps</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="google_map.html"> Google Map</a></li>
                        <li><a href="vector_map.html"> Vector Map</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="index.html"><i class="fa fa-file-text"></i> <span>Extra Pages</span></a>
                    <ul class="sub-menu-list">
        ...
        <div class="header-section">
            ...
            <div class="menu-right">
                <ul class="notification-menu">
                    <li>
                        <a href="index.html#" class="btn btn-default dropdown-toggle info-number" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list user-list">
                                ...
                                <li class="new"><a href="index.html">See All Pending Task</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                ...
                                <li class="new"><a href="index.html">Read All Mails</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                ...
                                <li class="new"><a href="index.html">See All Notifications</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                            ...
                            <div class="dir-info">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <h5>Wild Awake</h5>
                                        <span>
                                            <a href="index.html#" class="small"> katy Perry</a>
                                        </span>
                                    </div>
                                    <div class="col-xs-3">
                                        <a class="dir-like" href="index.html#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <h5>Bulet Proof</h5>
                                        <span>
                                            <a href="index.html#" class="small"> Bruno Mars</a>
                                        </span>
                                    </div>
                                    <div class="col-xs-3">
                                        <a class="dir-like" href="index.html#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <h5>Bit it</h5>
                                        <span>
                                            <a href="index.html#" class="small"> Jackson</a>
                                        </span>
                                    </div>
                                    <div class="col-xs-3">
                                        <a class="dir-like" href="index.html#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <h5>Its my life</h5>
                                        <span>
                                            <a href="index.html#" class="small"> Bon jovi</a>
                                        </span>
                                    </div>
                                    <div class="col-xs-3">
                                        <a class="dir-like" href="index.html#">
                            ...
                            <ul class="chats cool-chat">
                                <li class="in">
                                    ...
                                    <div class="message">
                                        ...
                                        <a class="name" href="index.html#">Jone Doe</a>
                                ...
                                <li class="out">
                                    ...
                                    <div class="message">
                                        <span class="arrow"></span>
                                        <a class="name" href="index.html#">Margarita Rose</a>
                    ...
                    <div class="panel blue-box twt-info">
                        <div class="panel-body">
                            ...
                            <p>AdminEx is new model of admin
                                dashboard <a href="index.html#">http://t.co/3laCVziTw4</a>
